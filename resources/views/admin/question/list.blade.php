<x-app-layout>
    <x-slot name="header"> {{'Soru ID: '.$quiz->id}}<br>
      <small>{{' Soru Başlık :  '.$quiz->title}}</small>
    </x-slot>
            ...
            @foreach ($quiz->questions as $question )
                ...
                <td>@if ($question->image == null) <b style="color: rgb(255, 0, 0)">---</b> @endif   {{$question->image}}</td>
                 ...
                 <td>
                    ...
                    <a href="{{Route('question.destroy',[$quiz->id,$question->id])}}"><b style="color: rgba(182, 7, 7, 0.64)">Sil</b></a> <br> 
